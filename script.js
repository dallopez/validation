...
function validate(){
  var messEle=document.body.querySelector(".vMess");
...
document.body.querySelector(".username").style.visibility="hidden"; document.body.querySelector(".validate").style.visibility="hidden";
  }else{
    messEle.innerHTML="Username invalid, please try again.";
  }
}
...
function aboutPage(){
  ...
  name.innerHTML="Dalila Lopez";
  display.appendChild(name); document.body.querySelector(".vdisplay").innerHTML=""; document.body.querySelector(".items").style.visibility="hidden";
document.body.querySelector(".subMess").style.visibility="hidden";
}
function homePage(){
  title.innerHTML="Home";
  display.appendChild(title); document.body.querySelector(".vdisplay").innerHTML=""; document.body.querySelector(".items").style.visibility="hidden"; document.body.querySelector(".subMess").style.visibility="hidden";
}
